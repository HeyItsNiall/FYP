...
Route::get('/manage_booking', [HomeController::class, 'manage_booking']);
...
Route::get('/update_stock/{id}', [HomeController::class, 'update_stock']);

Route::get('/pickuplist', [HomeController::class, 'pickuplist']);
Route::get('/deliverylist', [HomeController::class, 'deliverylist']);
