                        ...
                        <tr>
                            ...
                            <td>
                                @if ($order->delivery_status == 'processing')
                                    {{-- this will checking the delivery status --}}
                                    <a href="{{ url('delivered', $order->id) }}"
                                        onclick="return confirm('Are you sure this product is delivered ?  ')"
                                        class="btn btn-primary">Delivered</a> {{-- this button will shown if delivery status is processing --}}
                                @else
                                    <p style="color: green;">Delivered</p> {{-- this text will be shown if delivery status is delivered --}}
                                @endif
                            </td>
                            <td>
